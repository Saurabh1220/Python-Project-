...
scroll_bar.pack( side = RIGHT,
                fill = Y )
txt=Text(root)
txt.configure(bg='black',fg='white',font=('FrankRuehl',20,'bold'),yscrollcommand= scroll_bar.set,height=20)
...
def send():
    ...
    if(e.get()=="hello")or(e.get()=="hi") or (e.get()=="hey"):
        ...
        intro=['My name is Bicxy bot.','I am Bicxy bot.','Bicxy bot.']
...
e.place(x=20,y=400)
send=Button(root,width=7,text='Send',bg='yellow',fg='black',command=send,font=('Times New Roman',14))
send.place(x=300,y=400)
clear=Button(root,width=7,text='Clear',bg='yellow',fg='black',command=clear,font=('Times New Roman',14))
